...
export const metadata: Metadata = {
  title: "Privacy Policy | MP GK in Hindi 2026 MPESB",
  description:
    "Privacy policy for MP GK in Hindi 2026 MPESB explaining how we collect, use, and protect your information.",
  alternates: { canonical: "https://studyvirus.com/privacy/mpesb-vyapam" },
};
...
export default function PrivacyPolicyPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      />
      <h1 className="text-3xl font-black text-primary mb-2">MP GK in Hindi 2026 MPESB - Privacy Policy</h1>
      ...
      <article className="prose prose-slate max-w-none text-slate-700">
        <p>
          ...
          <strong>Package:</strong> com.gkpk.mpvyapam<br />
        ...
        <p className="text-sm text-slate-500">
          <strong>MP GK in Hindi 2026 MPESB</strong><br />
