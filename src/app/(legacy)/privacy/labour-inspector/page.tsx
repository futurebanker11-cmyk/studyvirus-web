...
export const metadata: Metadata = {
  title: "Privacy Policy | Labour Inspector PSSSB 2026 GK",
  description:
    "Privacy policy for Labour Inspector PSSSB 2026 GK explaining how we collect, use, and protect your information.",
  alternates: { canonical: "https://studyvirus.com/privacy/labour-inspector" },
};
...
export default function PrivacyPolicyPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      />
      <h1 className="text-3xl font-black text-primary mb-2">Labour Inspector PSSSB 2026 GK - Privacy Policy</h1>
      ...
      <article className="prose prose-slate max-w-none text-slate-700">
        <p>
          ...
          <strong>Package:</strong> com.gkpk.labourinsp<br />
        ...
        <p className="text-sm text-slate-500">
          <strong>Labour Inspector PSSSB 2026 GK</strong><br />
