...
export const metadata: Metadata = {
  title: "Privacy Policy | Haryana Forest Guard 2026 GK",
  description:
    "Privacy policy for Haryana Forest Guard 2026 GK explaining how we collect, use, and protect your information.",
...
export default function PrivacyPolicyPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      />
      <h1 className="text-3xl font-black text-primary mb-2">Haryana Forest Guard 2026 GK - Privacy Policy</h1>
      ...
      <article className="prose prose-slate max-w-none text-slate-700">
        ...
        <p className="text-sm text-slate-500">
          <strong>Haryana Forest Guard 2026 GK</strong><br />
