...
export const metadata: Metadata = {
  title: "Privacy Policy | Jharkhand Forest Guard GK 2026",
  description:
    "Privacy policy for Jharkhand Forest Guard GK 2026 explaining how we collect, use, and protect your information.",
  alternates: { canonical: "https://studyvirus.com/privacy/jharkhand-forest-guard" },
};
...
export default function PrivacyPolicyPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      />
      <h1 className="text-3xl font-black text-primary mb-2">Jharkhand Forest Guard GK 2026 - Privacy Policy</h1>
      ...
      <article className="prose prose-slate max-w-none text-slate-700">
        <p>
          <strong>Package:</strong> com.gkpk.jhforest<br />
        ...
        <p className="text-sm text-slate-500">
          <strong>Jharkhand Forest Guard GK 2026</strong><br />
