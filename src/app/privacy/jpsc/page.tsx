...
export const metadata: Metadata = {
  title: "Privacy Policy | JPSC GK 2026",
  description:
    "Privacy policy for JPSC GK 2026 explaining how we collect, use, and protect your information.",
...
export default function PrivacyPolicyPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      />
      <h1 className="text-3xl font-black text-primary mb-2">JPSC GK 2026 - Privacy Policy</h1>
