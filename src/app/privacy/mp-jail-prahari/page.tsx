...
export const metadata: Metadata = {
  title: "Privacy Policy | MP Jail Prahari Exam 2026 GK",
  description:
    "Privacy policy for MP Jail Prahari Exam 2026 GK explaining how we collect, use, and protect your information.",
  alternates: { canonical: "https://studyvirus.com/privacy/mp-jail-prahari" },
};
...
export default function PrivacyPolicyPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      />
      <h1 className="text-3xl font-black text-primary mb-2">MP Jail Prahari Exam 2026 GK - Privacy Policy</h1>
      ...
      <article className="prose prose-slate max-w-none text-slate-700">
        <p>
          ...
          <strong>Package:</strong> com.gkpk.mpjail<br />
        ...
        <p className="text-sm text-slate-500">
          <strong>MP Jail Prahari Exam 2026 GK</strong><br />
