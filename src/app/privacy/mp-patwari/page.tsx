...
export const metadata: Metadata = {
  title: "Privacy Policy | MP Patwari Exam 2026 GK Quiz",
  description:
    "Privacy policy for MP Patwari Exam 2026 GK Quiz explaining how we collect, use, and protect your information.",
  alternates: { canonical: "https://studyvirus.com/privacy/mp-patwari" },
};
...
export default function PrivacyPolicyPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      />
      <h1 className="text-3xl font-black text-primary mb-2">MP Patwari Exam 2026 GK Quiz - Privacy Policy</h1>
      ...
      <article className="prose prose-slate max-w-none text-slate-700">
        <p>
          ...
          <strong>Package:</strong> com.gkpk.mppatwari<br />
        ...
        <p className="text-sm text-slate-500">
          <strong>MP Patwari Exam 2026 GK Quiz</strong><br />
