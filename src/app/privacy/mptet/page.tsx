...
export const metadata: Metadata = {
  title: "Privacy Policy | MPTET Varg 3 Samvida Shikshak",
  description:
    "Privacy policy for MPTET Varg 3 Samvida Shikshak explaining how we collect, use, and protect your information.",
  alternates: { canonical: "https://studyvirus.com/privacy/mptet" },
};
...
export default function PrivacyPolicyPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      />
      <h1 className="text-3xl font-black text-primary mb-2">MPTET Varg 3 Samvida Shikshak - Privacy Policy</h1>
      ...
      <article className="prose prose-slate max-w-none text-slate-700">
        <p>
          ...
          <strong>Package:</strong> com.gkpk.mptet<br />
        ...
        <p className="text-sm text-slate-500">
          <strong>MPTET Varg 3 Samvida Shikshak</strong><br />
