...
export const metadata: Metadata = {
  title: "Privacy Policy | UP Jail Warder Bandi Rakshak",
  description:
    "Privacy policy for UP Jail Warder Bandi Rakshak explaining how we collect, use, and protect your information.",
  alternates: { canonical: "https://studyvirus.com/privacy/up-jail-prahari" },
};
...
export default function PrivacyPolicyPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      />
      <h1 className="text-3xl font-black text-primary mb-2">UP Jail Warder Bandi Rakshak - Privacy Policy</h1>
      ...
      <article className="prose prose-slate max-w-none text-slate-700">
        <p>
          ...
          <strong>Package:</strong> com.gkpk.upjail<br />
        ...
        <p className="text-sm text-slate-500">
          <strong>UP Jail Warder Bandi Rakshak</strong><br />
